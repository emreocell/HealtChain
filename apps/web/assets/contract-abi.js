window.MEDICAL_RECORD_REGISTRY_ABI = [
  ...
  "function addRecord(address patient, bytes32 dataHash, bytes32 recordTypeHash) returns (uint256 recordIndex)",
  "function revokeRecord(address patient, uint256 recordIndex)",
  "function getRecordCount(address patient) view returns (uint256)",
  "function getRecord(address patient, uint256 recordIndex) view returns (bytes32 dataHash, bytes32 recordTypeHash, address author, uint64 createdAt, bool revoked)",
  "event ProviderAuthorizationChanged(address indexed patient, address indexed provider, bool authorized)",
  "event RecordAdded(address indexed patient, uint256 indexed recordIndex, bytes32 indexed dataHash, bytes32 recordTypeHash, address author, uint64 createdAt)",
